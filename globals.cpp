...
const float gGameVisibleWorld_size_y = 158.f;
...
// ============ GUI VARIABLES =============
const float gGUI_size_x = gGameVisibleWorld_size_x;
const float gGUI_size_y = 35.0f;
const float gGUI_position_x = 0.0f;
const float gGUI_position_y = -gGUI_size_y;
...
const float gGUI_PlayerHpBar_position_y = 14.f - gGUI_size_y;
const float gGUI_BossHpBar_position_x = 55.f;
const float gGUI_BossHpBar_position_y = 24.f - gGUI_size_y;
...
const float gGameGS_size_y = gGUI_size_y + gGameVisibleWorld_size_y + gTileSize;
const float gGameGS_position_x = 0.0f;
const float gGameGS_position_y = -gGUI_size_y;
