...
3. Descomprimir el zip en el directorio del proyecto. Llamemos a la carpeta descomprimida "SDL3".
...
5. Finalmente, entramos a la carpeta SDL3/bin/ y copiamos el fichero "sdl3.dll" para pegarlo al lado del "main.cpp" del proyecto (de momento por conveniencia).
